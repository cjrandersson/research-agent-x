...
| Signal | Evidence | Sector | Strength | Action |
| --- | --- | --- | --- | --- |
| Manual EDI exception handling | 6 independent complaints | Supply chain | High | Deep dive |
| AI compliance tooling for NIS2 | Regulation + startup activity | Cybersecurity | Medium | Watch |
| Agent checkout protocols | Lots of media, little buyer evidence | Commerce | Low | Ignore for now |
...
| Opportunity | Status | Evidence | Commercial | Founder Fit |
| --- | --- | --- | --- | --- |
| EDI Exception Agent | 🟢 Strengthening | High | High | High |
| NIS2 Supplier Compliance | 🟡 Watch | Medium | Medium | High |
| Agent Checkout Infrastructure | 🟡 Watch | Low | Medium | Medium |
| BESS Optimization SaaS | 🔴 Weakening | Medium | High | Low |
